...
- (void)createSubView
{
    ...
    _dataSource1Btn = [self buttonWithLeftTitle:@"" titleColor:[UIColor whiteColor] Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor colorWithRed:20/255.0 green:140/255.0 blue:255.0 alpha:1.0] RightImageName:@"" Frame:CGRectMake(0, 0, (SCREEN_WIDTH-1)/3, 40)];
    ...
    _dataSource2Btn = [self buttonWithLeftTitle:@"" titleColor:[UIColor whiteColor] Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor colorWithRed:20/255.0 green:140/255.0 blue:255.0 alpha:1.0] RightImageName:@"PR_filter_choice" Frame:CGRectMake(_dataSource1Btn.x+_dataSource1Btn.width+0.5, 0, (SCREEN_WIDTH-1)/3, 40)];
...
{
    if (firstAry != nil) {
        [self changeBtn:_dataSource1Btn Text:[NSString stringWithFormat:@"%@",firstAry.firstObject] Font:[UIFont systemFontOfSize:13] ImageName:@""];
    ...
    if (thirdAry != nil) {
        [self changeBtn:_dataSource3Btn Text:[NSString stringWithFormat:@"%@",thirdAry.firstObject] Font:[UIFont systemFontOfSize:13] ImageName:@""];
